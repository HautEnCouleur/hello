...
_gulp2.default.task('styles', function () {
  return _gulp2.default.src('app/styles/*.scss').pipe($.plumber()).pipe($.clipEmptyFiles()).pipe($.sourcemaps.init()).pipe($.sass.sync({
...
_gulp2.default.task('html', ['views', 'styles'], function () {
  return _gulp2.default.src('.tmp/static/**/*.html').pipe($.useref({
    searchPath: ['.', '.tmp', '.tmp/includes', 'app', 'app/scripts', 'app/styles']
  })).pipe(_gulp2.default.dest('dist/static'));
});

_gulp2.default.task('php', ['html'], function () {
  return _gulp2.default.src('.tmp/**/*.php').pipe($.useref({
    searchPath: ['.', '.tmp', '.tmp/includes', 'app', 'app/scripts', 'app/styles']
...
_gulp2.default.task('extras', function () {
  return _gulp2.default.src(['app/**/*', '!app/{layouts,layouts/**}', '!app/{images,images/**}', '!app/{fonts,fonts/**}', '!app/{scripts,scripts/**}', '!app/**/*.html', '!app/**/*.scss', '!app/**/*.jade'], {
    dot: true
  }).pipe($.if('*.js', $.uglify())).pipe($.if('*.css', $.minifyCss({ compatibility: '*' })))
...
_gulp2.default.task('wiredep', function () {
  _gulp2.default.src('app/styles/*.scss').pipe($.plumber()).pipe($.clipEmptyFiles()).pipe((0, _wiredep.stream)({
    ignorePath: /^(\.\.\/)+/
  })).pipe(_gulp2.default.dest('app/styles'));

  _gulp2.default.src(['app/layouts/*.jade']).pipe($.plumber()).pipe($.clipEmptyFiles()).pipe((0, _wiredep.stream)({
...
// TODO : renable 'lint'
_gulp2.default.task('build', ['php', 'images', 'fonts', 'extras'], function () {
